...
"[project]/.next-internal/server/app/(chat)/api/vote/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/(chat)/api/vote/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (!chatId) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("bad_request:api", "Parameter chatId is required.").toResponse();
    }
    ...
    if (!session?.user) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("unauthorized:vote").toResponse();
    }
    ...
    if (!chat) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("not_found:chat").toResponse();
    }
    if (chat.userId !== session.user.id) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("forbidden:vote").toResponse();
    }
    const votes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$queries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getVotesByChatId"])({
        id: chatId
    });
...
async function PATCH(request) {
    ...
    if (!chatId || !messageId || !type) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("bad_request:api", "Parameters chatId, messageId, and type are required.").toResponse();
    }
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$auth$292f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"])();
    if (!session?.user) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("unauthorized:vote").toResponse();
    ...
    if (!chat) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("not_found:vote").toResponse();
    }
    if (chat.userId !== session.user.id) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("forbidden:vote").toResponse();
    }
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$queries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["voteMessage"])({
        chatId,
        messageId,
        type
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__396fec8b._.js.map