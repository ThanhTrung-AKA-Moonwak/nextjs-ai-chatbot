...
"[project]/node_modules/.pnpm/next@15.3.0-canary.31_@opentelemetry+api@1.9.0_@playwright+test@1.51.0_react-dom@19.0.0-rc-45_mlqzopqn56t6gad76627omqvii/node_modules/next/dist/compiled/react-dom-experimental/cjs/react-dom-client.development.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function traverseFragmentInstanceChildren(child, fn, a, b, c) {
        for(; null !== child;){
            ...
            } else 22 === child.tag && null !== child.memoizedState || traverseFragmentInstanceChildren(child.child, fn, a, b, c);
            child = child.sibling;
        }
    }
    ...
    function updateSuspenseComponent(current, workInProgress, renderLanes) {
        var JSCompiler_object_inline_componentStack_2828;
        var JSCompiler_object_inline_stack_2827 = workInProgress.pendingProps;
        shouldSuspendImpl(workInProgress) && (workInProgress.flags |= 128);
        var JSCompiler_object_inline_message_2825 = !1;
        var didSuspend = 0 !== (workInProgress.flags & 128);
        (JSCompiler_object_inline_componentStack_2828 = didSuspend) || (JSCompiler_object_inline_componentStack_2828 = null !== current && null === current.memoizedState ? !1 : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_componentStack_2828 && (JSCompiler_object_inline_message_2825 = !0, workInProgress.flags &= -129);
        JSCompiler_object_inline_componentStack_2828 = 0 !== (workInProgress.flags & 32);
        workInProgress.flags &= -33;
        if (null === current) {
            if (isHydrating) {
                JSCompiler_object_inline_message_2825 ? pushPrimaryTreeSuspenseHandler(workInProgress) : reuseSuspenseHandlerOnStack(workInProgress);
                if (isHydrating) {
                    var JSCompiler_object_inline_digest_2826 = nextHydratableInstance;
                    var JSCompiler_temp;
                    if (!(JSCompiler_temp = !JSCompiler_object_inline_digest_2826)) {
                        c: {
                            var instance = JSCompiler_object_inline_digest_2826;
                    ...
                    JSCompiler_temp && (warnNonHydratedInstance(workInProgress, JSCompiler_object_inline_digest_2826), throwOnHydrationMismatch(workInProgress));
                }
                JSCompiler_object_inline_digest_2826 = workInProgress.memoizedState;
                if (null !== JSCompiler_object_inline_digest_2826 && (JSCompiler_object_inline_digest_2826 = JSCompiler_object_inline_digest_2826.dehydrated, null !== JSCompiler_object_inline_digest_2826)) return isSuspenseInstanceFallback(JSCompiler_object_inline_digest_2826) ? workInProgress.lanes = 32 : workInProgress.lanes = 536870912, null;
                popSuspenseHandler(workInProgress);
            }
            JSCompiler_object_inline_digest_2826 = JSCompiler_object_inline_stack_2827.children;
            JSCompiler_temp = JSCompiler_object_inline_stack_2827.fallback;
            if (JSCompiler_object_inline_message_2825) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_stack_2827 = mountSuspenseFallbackChildren(workInProgress, JSCompiler_object_inline_digest_2826, JSCompiler_temp, renderLanes), JSCompiler_object_inline_message_2825 = workInProgress.child, JSCompiler_object_inline_message_2825.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_message_2825.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2828, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2827;
            if ("number" === typeof JSCompiler_object_inline_stack_2827.unstable_expectedLoadTime) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_stack_2827 = mountSuspenseFallbackChildren(workInProgress, JSCompiler_object_inline_digest_2826, JSCompiler_temp, renderLanes), JSCompiler_object_inline_message_2825 = workInProgress.child, JSCompiler_object_inline_message_2825.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_message_2825.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2828, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress.lanes = 4194304, JSCompiler_object_inline_stack_2827;
            pushPrimaryTreeSuspenseHandler(workInProgress);
            return mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_digest_2826);
        }
        var prevState = current.memoizedState;
        if (null !== prevState && (JSCompiler_object_inline_digest_2826 = prevState.dehydrated, null !== JSCompiler_object_inline_digest_2826)) {
            if (didSuspend) workInProgress.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress), workInProgress.flags &= -257, workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes)) : null !== workInProgress.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress), workInProgress.child = current.child, workInProgress.flags |= 128, workInProgress = null) : (reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_message_2825 = JSCompiler_object_inline_stack_2827.fallback, JSCompiler_object_inline_digest_2826 = workInProgress.mode, JSCompiler_object_inline_stack_2827 = mountWorkInProgressOffscreenFiber({
                mode: "visible",
                children: JSCompiler_object_inline_stack_2827.children
            }, JSCompiler_object_inline_digest_2826), JSCompiler_object_inline_message_2825 = createFiberFromFragment(JSCompiler_object_inline_message_2825, JSCompiler_object_inline_digest_2826, renderLanes, null), JSCompiler_object_inline_message_2825.flags |= 2, JSCompiler_object_inline_stack_2827.return = workInProgress, JSCompiler_object_inline_message_2825.return = workInProgress, JSCompiler_object_inline_stack_2827.sibling = JSCompiler_object_inline_message_2825, workInProgress.child = JSCompiler_object_inline_stack_2827, reconcileChildFibers(workInProgress, current.child, null, renderLanes), JSCompiler_object_inline_stack_2827 = workInProgress.child, JSCompiler_object_inline_stack_2827.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_stack_2827.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2828, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress = JSCompiler_object_inline_message_2825);
            else if (pushPrimaryTreeSuspenseHandler(workInProgress), isHydrating && console.error("We should not be hydrating here. This is a bug in React. Please file a bug."), isSuspenseInstanceFallback(JSCompiler_object_inline_digest_2826)) {
                JSCompiler_object_inline_componentStack_2828 = JSCompiler_object_inline_digest_2826.nextSibling && JSCompiler_object_inline_digest_2826.nextSibling.dataset;
                if (JSCompiler_object_inline_componentStack_2828) {
                    JSCompiler_temp = JSCompiler_object_inline_componentStack_2828.dgst;
                    var message = JSCompiler_object_inline_componentStack_2828.msg;
                    instance = JSCompiler_object_inline_componentStack_2828.stck;
                    var componentStack = JSCompiler_object_inline_componentStack_2828.cstck;
                }
                JSCompiler_object_inline_message_2825 = message;
                JSCompiler_object_inline_digest_2826 = JSCompiler_temp;
                JSCompiler_object_inline_stack_2827 = instance;
                JSCompiler_temp = JSCompiler_object_inline_componentStack_2828 = componentStack;
                "POSTPONE" !== JSCompiler_object_inline_digest_2826 && (JSCompiler_object_inline_componentStack_2828 = JSCompiler_object_inline_message_2825 ? Error(JSCompiler_object_inline_message_2825) : Error("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering."), JSCompiler_object_inline_componentStack_2828.stack = JSCompiler_object_inline_stack_2827 || "", JSCompiler_object_inline_componentStack_2828.digest = JSCompiler_object_inline_digest_2826, JSCompiler_object_inline_stack_2827 = void 0 === JSCompiler_temp ? null : JSCompiler_temp, JSCompiler_object_inline_message_2825 = {
                    value: JSCompiler_object_inline_componentStack_2828,
                    source: null,
                    stack: JSCompiler_object_inline_stack_2827
                }, "string" === typeof JSCompiler_object_inline_stack_2827 && CapturedStacks.set(JSCompiler_object_inline_componentStack_2828, JSCompiler_object_inline_message_2825), queueHydrationError(JSCompiler_object_inline_message_2825));
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else if (didReceiveUpdate || propagateParentContextChanges(current, workInProgress, renderLanes, !1), JSCompiler_object_inline_componentStack_2828 = 0 !== (renderLanes & current.childLanes), didReceiveUpdate || JSCompiler_object_inline_componentStack_2828) {
                JSCompiler_object_inline_componentStack_2828 = workInProgressRoot;
                if (null !== JSCompiler_object_inline_componentStack_2828 && (JSCompiler_object_inline_stack_2827 = renderLanes & -renderLanes, JSCompiler_object_inline_stack_2827 = 0 !== (JSCompiler_object_inline_stack_2827 & 42) ? 1 : getBumpedLaneForHydrationByLane(JSCompiler_object_inline_stack_2827), JSCompiler_object_inline_stack_2827 = 0 !== (JSCompiler_object_inline_stack_2827 & (JSCompiler_object_inline_componentStack_2828.suspendedLanes | renderLanes)) ? 0 : JSCompiler_object_inline_stack_2827, 0 !== JSCompiler_object_inline_stack_2827 && JSCompiler_object_inline_stack_2827 !== prevState.retryLane)) throw prevState.retryLane = JSCompiler_object_inline_stack_2827, enqueueConcurrentRenderForLane(current, JSCompiler_object_inline_stack_2827), scheduleUpdateOnFiber(JSCompiler_object_inline_componentStack_2828, current, JSCompiler_object_inline_stack_2827), SelectiveHydrationException;
                JSCompiler_object_inline_digest_2826.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else JSCompiler_object_inline_digest_2826.data === SUSPENSE_PENDING_START_DATA ? (workInProgress.flags |= 192, workInProgress.child = current.child, workInProgress = null) : (current = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_digest_2826.nextSibling), hydrationParentFiber = workInProgress, isHydrating = !0, hydrationErrors = null, didSuspendOrErrorDEV = !1, hydrationDiffRootDEV = null, rootOrSingletonContext = !1, null !== current && (warnIfNotHydrating(), idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current.id, treeContextOverflow = current.overflow, treeContextProvider = workInProgress), workInProgress = mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_stack_2827.children), workInProgress.flags |= 4096);
            return workInProgress;
        }
        if (JSCompiler_object_inline_message_2825) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_message_2825 = JSCompiler_object_inline_stack_2827.fallback, JSCompiler_object_inline_digest_2826 = workInProgress.mode, JSCompiler_temp = current.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2827 = createWorkInProgress(JSCompiler_temp, {
            mode: "hidden",
            children: JSCompiler_object_inline_stack_2827.children
        }), JSCompiler_object_inline_stack_2827.subtreeFlags = JSCompiler_temp.subtreeFlags & 65011712, null !== instance ? JSCompiler_object_inline_message_2825 = createWorkInProgress(instance, JSCompiler_object_inline_message_2825) : (JSCompiler_object_inline_message_2825 = createFiberFromFragment(JSCompiler_object_inline_message_2825, JSCompiler_object_inline_digest_2826, renderLanes, null), JSCompiler_object_inline_message_2825.flags |= 2), JSCompiler_object_inline_message_2825.return = workInProgress, JSCompiler_object_inline_stack_2827.return = workInProgress, JSCompiler_object_inline_stack_2827.sibling = JSCompiler_object_inline_message_2825, workInProgress.child = JSCompiler_object_inline_stack_2827, JSCompiler_object_inline_stack_2827 = JSCompiler_object_inline_message_2825, JSCompiler_object_inline_message_2825 = workInProgress.child, JSCompiler_object_inline_digest_2826 = current.child.memoizedState, null === JSCompiler_object_inline_digest_2826 ? JSCompiler_object_inline_digest_2826 = mountSuspenseOffscreenState(renderLanes) : (JSCompiler_temp = JSCompiler_object_inline_digest_2826.cachePool, null !== JSCompiler_temp ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? {
            parent: instance,
            pool: instance
        } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_digest_2826 = {
            baseLanes: JSCompiler_object_inline_digest_2826.baseLanes | renderLanes,
            cachePool: JSCompiler_temp
        }), JSCompiler_object_inline_message_2825.memoizedState = JSCompiler_object_inline_digest_2826, JSCompiler_object_inline_message_2825.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2828, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2827;
        pushPrimaryTreeSuspenseHandler(workInProgress);
        ...
        null !== current && (JSCompiler_object_inline_componentStack_2828 = workInProgress.deletions, null === JSCompiler_object_inline_componentStack_2828 ? (workInProgress.deletions = [
            current
        ], workInProgress.flags |= 16) : JSCompiler_object_inline_componentStack_2828.push(current));
        ...
        if (null !== ref) {
            switch(finishedWork.tag){
                ...
                case 30:
                    ...
                    break;
                case 7:
                    null === finishedWork.stateNode && (finishedWork.stateNode = new FragmentInstance(finishedWork));
                    instanceToUse = finishedWork.stateNode;
                    break;
                default:
                    instanceToUse = finishedWork.stateNode;
    ...
    function commitNewChildToFragmentInstances(fiber, parentFragmentInstances) {
        for(var i = 0; i < parentFragmentInstances.length; i++)commitNewChildToFragmentInstance(fiber.stateNode, parentFragmentInstances[i]);
    }
    function commitFragmentInstanceDeletionEffects(fiber) {
        for(var parent = fiber.return; null !== parent;){
            if (isFragmentInstanceParent(parent)) {
                var childElement = fiber.stateNode, eventListeners = parent.stateNode._eventListeners;
                if (null !== eventListeners) for(var i = 0; i < eventListeners.length; i++){
                    var _eventListeners$i2 = eventListeners[i];
                    childElement.removeEventListener(_eventListeners$i2.type, _eventListeners$i2.listener, _eventListeners$i2.optionsOrUseCapture);
                }
            }
    ...
    function insertOrAppendPlacementNode(node, before, parent, parentFragmentInstances) {
        ...
        if (5 === tag || 6 === tag) {
            var stateNode = node.stateNode;
            before ? supportsMoveBefore && null !== stateNode.parentNode ? parent.moveBefore(stateNode, before) : parent.insertBefore(stateNode, before) : appendChild(parent, stateNode);
            5 === tag && null === node.alternate && null !== parentFragmentInstances && commitNewChildToFragmentInstances(node, parentFragmentInstances);
            viewTransitionMutationContext = !0;
        ...
        if (0 !== (placement.subtreeFlags & 18874368)) for(placement = placement.child; null !== placement;){
            if (22 !== placement.tag || null !== placement.memoizedState) {
                if (commitAppearingPairViewTransitions(placement), 30 === placement.tag && 0 !== (placement.flags & 18874368) && placement.stateNode.paired) {
                    ...
                    "none" !== props && (applyViewTransitionToHostInstances(placement.child, name, props, null, !1) || restoreViewTransitionOnHostInstances(placement.child, !1));
                }
            }
                    ...
                    if (30 === deletion.tag && 0 !== (deletion.flags & 18874368)) {
                        ...
                        if (null != name && "auto" !== name) {
                            ...
                            if (void 0 !== pair) {
                                ...
                                "none" !== className && (applyViewTransitionToHostInstances(deletion.child, name, className, null, !1) ? (className = deletion.stateNode, pair.paired = className, className.paired = pair, scheduleViewTransitionEvent(deletion, props.onShare)) : restoreViewTransitionOnHostInstances(deletion.child, !1));
                                pairs.delete(name);
    ...
    function commitExitViewTransitions(deletion) {
        if (30 === deletion.tag) {
            ...
            "none" !== className && (applyViewTransitionToHostInstances(deletion.child, name, className, null, !1) ? void 0 !== pair ? (className = deletion.stateNode, pair.paired = className, className.paired = pair, appearingViewTransitions.delete(name), scheduleViewTransitionEvent(deletion, props.onShare)) : scheduleViewTransitionEvent(deletion, props.onExit) : restoreViewTransitionOnHostInstances(deletion.child, !1));
    ...
    function commitNestedViewTransitions(changedParent) {
        for(changedParent = changedParent.child; null !== changedParent;){
            if (30 === changedParent.tag) {
                ...
                "none" !== props && applyViewTransitionToHostInstances(changedParent.child, name, props, changedParent.memoizedState = [], !1);
    ...
    function measureUpdateViewTransition(current, finishedWork, gesture) {
        ...
        viewTransitionHostInstanceIdx = 0;
        current = measureViewTransitionHostInstancesRecursive(finishedWork, oldFiber, current, oldName, props, gesture, !0);
    ...
    function commitBeforeMutationEffects(root, firstChild, committedLanes) {
        ...
        for(firstChild = committedLanes ? 9270 : 1028; null !== nextEffect;){
            ...
            if (null === root.alternate && 0 !== (root.flags & 2)) committedLanes && trackEnterViewTransitions$1(root), commitBeforeMutationEffects_complete(committedLanes);
            else {
                if (22 === root.tag) {
    ...
    function commitLayoutEffectOnFiber(finishedRoot, current, finishedWork) {
        ...
        switch(finishedWork.tag){
            ...
            case 13:
                ...
                flags & 64 && (finishedRoot = finishedWork.memoizedState, null !== finishedRoot && (finishedRoot = finishedRoot.dehydrated, null !== finishedRoot && (current = retryDehydratedSuspenseBoundary.bind(null, finishedWork), registerSuspenseInstanceRetry(finishedRoot, current))));
                break;
            case 22:
    ...
    function commitAfterMutationEffectsOnFiber(finishedWork, root) {
        ...
        if (null === current) commitEnterViewTransitions(finishedWork, !1);
            ...
            case 30:
                ...
                0 !== (finishedWork.flags & 4) && root ? (scheduleViewTransitionEvent(finishedWork, finishedWork.memoizedProps.onUpdate), viewTransitionCancelableChildren = prevCancelableChildren) : null !== prevCancelableChildren && (prevCancelableChildren.push.apply(prevCancelableChildren, viewTransitionCancelableChildren), viewTransitionCancelableChildren = prevCancelableChildren);
                viewTransitionContextChanged$1 = 0 !== (finishedWork.flags & 32) ? !0 : i;
                break;
            default:
                recursivelyTraverseAfterMutationEffects(root, finishedWork);
        }
    ...
    function commitPassiveMountOnFiber(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) {
        var prevEffectStart = pushComponentEffectStart(), prevEffectErrors = pushComponentEffectErrors(), isViewTransitionEligible = (committedLanes & 335544064) === committedLanes;
        ...
        switch(finishedWork.tag){
            ...
            case 22:
                ...
                null !== finishedWork.memoizedState ? (isViewTransitionEligible && null !== wasInHydratedSubtree && null === wasInHydratedSubtree.memoizedState && restoreEnterOrExitViewTransitions(wasInHydratedSubtree), prevEffectDuration._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) : recursivelyTraverseAtomicPassiveEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime)) : (isViewTransitionEligible && null !== wasInHydratedSubtree && null !== wasInHydratedSubtree.memoizedState && restoreEnterOrExitViewTransitions(finishedWork), prevEffectDuration._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) : (prevEffectDuration._visibility |= OffscreenPassiveEffectsConnected, recursivelyTraverseReconnectPassiveEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, 0 !== (finishedWork.subtreeFlags & 10256), endTime)));
            ...
            case 24:
                ...
                break;
            case 30:
                isViewTransitionEligible && (isViewTransitionEligible = finishedWork.alternate, null !== isViewTransitionEligible && (restoreViewTransitionOnHostInstances(isViewTransitionEligible.child, !0), restoreViewTransitionOnHostInstances(finishedWork.child, !0)));
                recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
                break;
            default:
                recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
    ...
    function applyViewTransitionToClones(name, className, clones) {
        for(var i = 0; i < clones.length; i++)applyViewTransitionName(clones[i], 0 === i ? name : name + "_" + i, className);
    }
    ...
    function trackEnterViewTransitions(deletion) {
        if (30 === deletion.tag) {
            ...
            props = getViewTransitionClassName(props.default, void 0 !== pair ? props.share : props.enter);
            ...
            trackDeletedPairViewTransitions(deletion);
        } else if (0 !== (deletion.subtreeFlags & 33554432)) for(deletion = deletion.child; null !== deletion;)trackEnterViewTransitions(deletion), deletion = deletion.sibling;
    ...
    function applyExitViewTransition(placement) {
        ...
        props = getViewTransitionClassName(props.default, state.paired ? props.share : props.exit);
    ...
    function recursivelyInsertNew(parentFiber, hostParentClone, parentViewTransition, visitPhase) {
        if (visitPhase !== INSERT_APPEARING_PAIR || null !== parentViewTransition || 0 !== (parentFiber.subtreeFlags & 18874368)) for(parentFiber = parentFiber.child; null !== parentFiber;)recursivelyInsertNewFiber(parentFiber, hostParentClone, parentViewTransition, visitPhase), parentFiber = parentFiber.sibling;
    }
    function recursivelyInsertNewFiber(finishedWork, hostParentClone, parentViewTransition, visitPhase) {
        switch(finishedWork.tag){
            ...
            case 27:
                recursivelyInsertNew(finishedWork, hostParentClone, parentViewTransition, visitPhase);
                finishedWork.flags & 4 && console.error("useSwipeTransition() caused something to render a new <%s>. This is not possible in the current implementation. Make sure that the swipe doesn't mount any new <%s> elements.", finishedWork.type, finishedWork.type);
                break;
            case 5:
                var instance = finishedWork.stateNode;
                visitPhase !== INSERT_APPEARING_PAIR ? (appendChild(hostParentClone, instance), viewTransitionMutationContext = !0, recursivelyInsertNew(finishedWork, instance, null, INSERT_APPEARING_PAIR)) : recursivelyInsertNew(finishedWork, instance, null, visitPhase);
                null !== parentViewTransition && (null === parentViewTransition.clones ? parentViewTransition.clones = [
                    instance
                ] : parentViewTransition.clones.push(instance));
                break;
            case 6:
                finishedWork = finishedWork.stateNode;
                if (null === finishedWork) throw Error("This should have a text node initialized. This error is likely caused by a bug in React. Please file an issue.");
                visitPhase !== INSERT_APPEARING_PAIR && (appendChild(hostParentClone, finishedWork), viewTransitionMutationContext = !0);
                break;
            case 4:
                break;
            case 22:
                null === finishedWork.memoizedState && recursivelyInsertNew(finishedWork, hostParentClone, parentViewTransition, visitPhase);
                break;
            case 30:
                parentViewTransition = pushMutationContext();
                instance = finishedWork.stateNode;
                instance.clones = null;
                recursivelyInsertNew(finishedWork, hostParentClone, instance, visitPhase === INSERT_EXIT ? INSERT_APPEND : visitPhase);
                visitPhase === INSERT_EXIT ? applyExitViewTransition(finishedWork) : (visitPhase === INSERT_APPEARING_PAIR || visitPhase === INSERT_APPEND) && applyAppearingPairViewTransition(finishedWork);
                ...
                case 5:
                    ...
                    switch(visitPhase){
                        ...
                        case CLONE_APPEARING_PAIR:
                            var _nextPhase = 0 !== (parentFiber.subtreeFlags & 18874368) ? CLONE_APPEARING_PAIR : CLONE_UNCHANGED;
                            break;
                        default:
                            _nextPhase = CLONE_UNCHANGED;
                    }
                    _nextPhase !== CLONE_UNCHANGED ? (instance = instance.cloneNode(!1), recursivelyInsertClonesFromExistingTree(parentFiber, instance, null, _nextPhase)) : instance = instance.cloneNode(!0);
                    appendChild(hostParentClone, instance);
                    null !== parentViewTransition && (null === parentViewTransition.clones ? parentViewTransition.clones = [
                        instance
                    ] : parentViewTransition.clones.push(instance));
                    if (visitPhase === CLONE_EXIT || visitPhase === CLONE_UNHIDE) unhideInstance(instance, parentFiber.memoizedProps), viewTransitionMutationContext = !0;
                    break;
                case 6:
                    _nextPhase = parentFiber.stateNode;
                    if (null === _nextPhase) throw Error("This should have a text node initialized. This error is likely caused by a bug in React. Please file an issue.");
                    _nextPhase = _nextPhase.cloneNode(!1);
                    appendChild(hostParentClone, _nextPhase);
                    if (visitPhase === CLONE_EXIT || visitPhase === CLONE_UNHIDE) _nextPhase.nodeValue = parentFiber.memoizedProps, viewTransitionMutationContext = !0;
                    break;
                case 4:
                    break;
                case 22:
                    null === parentFiber.memoizedState && recursivelyInsertClonesFromExistingTree(parentFiber, hostParentClone, parentViewTransition, visitPhase);
                    break;
                case 30:
                    _nextPhase = pushMutationContext();
                    instance = parentFiber.stateNode;
                    instance.clones = null;
                    recursivelyInsertClonesFromExistingTree(parentFiber, hostParentClone, instance, visitPhase === CLONE_EXIT ? CLONE_UNHIDE : visitPhase === CLONE_UPDATE ? CLONE_UNCHANGED : visitPhase);
                    if (visitPhase === CLONE_EXIT) applyExitViewTransition(parentFiber);
                    else if (visitPhase === CLONE_APPEARING_PAIR || visitPhase === CLONE_UNHIDE) applyAppearingPairViewTransition(parentFiber);
                    ...
                    viewTransitionMutationContext = _nextPhase;
                    break;
                default:
    ...
    function recursivelyInsertClones(parentFiber, hostParentClone$jscomp$0, parentViewTransition, visitPhase$jscomp$0) {
        var deletions = parentFiber.deletions;
        if (null !== deletions) for(var i = 0; i < deletions.length; i++)trackEnterViewTransitions(deletions[i]), viewTransitionMutationContext = !0;
        if (null === parentFiber.alternate || 0 !== (parentFiber.subtreeFlags & 13878)) for(parentFiber = parentFiber.child; null !== parentFiber;){
            ...
            if (null === i) recursivelyInsertNewFiber(deletions, hostParentClone, nextPhase, INSERT_EXIT);
            else {
                var flags = deletions.flags;
                switch(deletions.tag){
                    case 26:
                        recursivelyInsertClones(deletions, hostParentClone, nextPhase, visitPhase);
                        break;
                    case 27:
                        recursivelyInsertClones(deletions, hostParentClone, nextPhase, visitPhase);
                        if (flags & 4) {
                            ...
                            try {
                                commitUpdate(visitPhase, flags, i, hostParentClone, deletions), viewTransitionMutationContext && console.error("useSwipeTransition() caused something to mutate <%s>. This is not possible in the current implementation. Make sure that the swipe doesn't update any state which causes <%s> to change.", deletions.type, deletions.type), commitUpdate(visitPhase, flags, hostParentClone, i, deletions);
                            } finally{
                    ...
                    case 5:
                        ...
                        null === deletions.child ? (clone = clone.cloneNode(!0), deletions.flags & 32 && (resetTextContent(clone), viewTransitionMutationContext = !0)) : clone = clone.cloneNode(!1);
                        flags & 4 && commitUpdate(clone, deletions.type, i.memoizedProps, deletions.memoizedProps);
                        visitPhase === CLONE_EXIT || visitPhase === CLONE_UNHIDE ? (recursivelyInsertClones(deletions, clone, null, CLONE_APPEARING_PAIR), appendChild(hostParentClone, clone), unhideInstance(clone, deletions.memoizedProps), viewTransitionMutationContext = !0) : (recursivelyInsertClones(deletions, clone, null, visitPhase), appendChild(hostParentClone, clone));
                        null !== nextPhase && (null === nextPhase.clones ? nextPhase.clones = [
                            clone
                        ] : nextPhase.clones.push(clone));
                        break;
                    case 6:
                        nextPhase = deletions.stateNode;
                        if (null === nextPhase) throw Error("This should have a text node initialized. This error is likely caused by a bug in React. Please file an issue.");
                        nextPhase = nextPhase.cloneNode(!1);
                        flags & 4 && (nextPhase.nodeValue = i.memoizedProps, viewTransitionMutationContext = !0);
                        appendChild(hostParentClone, nextPhase);
                        if (visitPhase === CLONE_EXIT || visitPhase === CLONE_UNHIDE) nextPhase.nodeValue = deletions.memoizedProps, viewTransitionMutationContext = !0;
                        break;
                    case 4:
                        break;
                    case 22:
                        null === deletions.memoizedState ? (i = visitPhase === CLONE_UPDATE && 0 !== (flags & 8192) ? CLONE_EXIT : visitPhase, recursivelyInsertClones(deletions, hostParentClone, nextPhase, i)) : null !== i && null === i.memoizedState && (trackEnterViewTransitions(i), viewTransitionMutationContext = !0);
                        break;
                    case 30:
                        flags = pushMutationContext();
                        clone = deletions.stateNode;
                        clone.clones = null;
                        nextPhase = visitPhase === CLONE_EXIT ? CLONE_UNHIDE : visitPhase;
                        recursivelyInsertClones(deletions, hostParentClone, clone, nextPhase);
                        viewTransitionMutationContext && (deletions.flags |= 4);
                        visitPhase === CLONE_EXIT ? applyExitViewTransition(deletions) : visitPhase === CLONE_APPEARING_PAIR || visitPhase === CLONE_UNHIDE ? applyAppearingPairViewTransition(deletions) : visitPhase === CLONE_UPDATE && (hostParentClone = deletions.stateNode, i = i.memoizedProps, deletions = getViewTransitionName(deletions.memoizedProps, hostParentClone), i = getViewTransitionClassName(i.default, i.update), "none" !== i && (hostParentClone = hostParentClone.clones, null !== hostParentClone && applyViewTransitionToClones(deletions, i, hostParentClone)));
                        viewTransitionMutationContext = flags;
                        break;
                    default:
                        recursivelyInsertClones(deletions, hostParentClone, nextPhase, visitPhase);
        ...
        else recursivelyInsertClonesFromExistingTree(parentFiber, hostParentClone$jscomp$0, parentViewTransition, visitPhase$jscomp$0);
    }
    function recursivelyApplyViewTransitions(parentFiber) {
        var deletions = parentFiber.deletions;
        if (null !== deletions) for(var i = 0; i < deletions.length; i++)commitEnterViewTransitions(deletions[i], !0);
        if (null === parentFiber.alternate || 0 !== (parentFiber.subtreeFlags & 13878)) for(parentFiber = parentFiber.child; null !== parentFiber;){
            deletions = parentFiber;
            i = deletions.alternate;
            if (null !== i) {
                ...
                switch(deletions.tag){
                    case 4:
                        break;
                    case 22:
                        flags & 8192 && null !== deletions.memoizedState && null !== i && null === i.memoizedState && commitEnterViewTransitions(i, !0);
                        break;
                    case 30:
                        ...
                        0 !== (deletions.flags & 4) && i ? viewTransitionCancelableChildren = prevCancelableChildren : null !== prevCancelableChildren && (prevCancelableChildren.push.apply(prevCancelableChildren, viewTransitionCancelableChildren), viewTransitionCancelableChildren = prevCancelableChildren);
                        viewTransitionContextChanged = 0 !== (deletions.flags & 32) ? !0 : flags;
    ...
    function recursivelyRestoreViewTransitions(parentFiber) {
        var deletions = parentFiber.deletions;
        if (null !== deletions) for(var i = 0; i < deletions.length; i++)restoreEnterOrExitViewTransitions(deletions[i]);
        if (null === parentFiber.alternate || 0 !== (parentFiber.subtreeFlags & 13878)) for(parentFiber = parentFiber.child; null !== parentFiber;)restoreViewTransitionsOnFiber(parentFiber), parentFiber = parentFiber.sibling;
    ...
    function commitRoot(root, finishedWork, lanes, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, spawnedLane, updatedLanes, suspendedRetryLanes, exitStatus, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
        ...
        if (null === finishedWork) null !== root.stoppingGestures && stopCompletedGestures(root);
            ...
            if (64 === lanes) commitGestureOnRoot(root, finishedWork);
                ...
                finishedWork ? pendingViewTransition = startViewTransition(root.containerInfo, pendingTransitionTypes, flushMutationEffects, flushLayoutEffects, flushAfterMutationEffects, flushSpawnedWork, flushPassiveEffects, reportViewTransitionError) : (flushMutationEffects(), flushLayoutEffects(), flushSpawnedWork());
            }
        }
    }
        ...
        if (pendingEffectsStatus === PENDING_GESTURE_MUTATION_PHASE) {
            ...
            try {
                ...
                if (!viewTransitionContextChanged) {
                    finishedWork = viewTransitionCancelableChildren;
                    if (null !== finishedWork) for(rootClone = 0; rootClone < finishedWork.length; rootClone += 3)cancelViewTransitionName(finishedWork[rootClone], finishedWork[rootClone + 1], finishedWork[rootClone + 2]);
    ...
    function flushGestureAnimations() {
        ...
        if (pendingEffectsStatus === PENDING_GESTURE_ANIMATION_PHASE) {
            pendingEffectsStatus = NO_PENDING_EFFECTS;
            var root = pendingEffectsRoot, finishedWork = pendingFinishedWork;
            ...
            executionContext |= CommitContext;
            try {
                restoreViewTransitionsOnFiber(finishedWork), restoreRootViewTransitionName(root.containerInfo);
            } finally{
                executionContext = prevExecutionContext, ReactDOMSharedInternals.p = previousPriority, ReactSharedInternals.T = prevTransition;
            }
            ensureRootIsScheduled(root);
        ...
        try {
            var transition = ownerDocument.startViewTransition({
                update: function() {
                    ...
                    mutationCallback();
                    if ("loaded" === previousFontLoadingStatus && (forceLayout(ownerDocument), "loading" === ownerDocument.fonts.status)) return previousFontLoadingStatus = Promise.race([
    ...
    function commitNewChildToFragmentInstance(childElement, fragmentInstance) {
        ...
        if (null !== eventListeners) for(var i = 0; i < eventListeners.length; i++){
            ...
            childElement.addEventListener(_eventListeners$i.type, _eventListeners$i.listener, _eventListeners$i.optionsOrUseCapture);
        }
    ...
    var Scheduler = __turbopack_context__.r("[project]/node_modules/.pnpm/next@15.3.0-canary.31_@opentelemetry+api@1.9.0_@playwright+test@1.51.0_react-dom@19.0.0-rc-45_mlqzopqn56t6gad76627omqvii/node_modules/next/dist/compiled/scheduler-experimental/index.js [app-ssr] (ecmascript)"), React = __turbopack_context__.r("[project]/node_modules/.pnpm/next@15.3.0-canary.31_@opentelemetry+api@1.9.0_@playwright+test@1.51.0_react-dom@19.0.0-rc-45_mlqzopqn56t6gad76627omqvii/node_modules/next/dist/compiled/react-experimental/index.js [app-ssr] (ecmascript)"), ReactDOM = __turbopack_context__.r("[project]/node_modules/.pnpm/next@15.3.0-canary.31_@opentelemetry+api@1.9.0_@playwright+test@1.51.0_react-dom@19.0.0-rc-45_mlqzopqn56t6gad76627omqvii/node_modules/next/dist/compiled/react-dom-experimental/index.js [app-ssr] (ecmascript)"), assign = Object.assign, REACT_LEGACY_ELEMENT_TYPE = Symbol.for("react.element"), REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE = Symbol.for("react.profiler"), REACT_PROVIDER_TYPE = Symbol.for("react.provider"), REACT_CONSUMER_TYPE = Symbol.for("react.consumer"), REACT_CONTEXT_TYPE = Symbol.for("react.context"), REACT_FORWARD_REF_TYPE = Symbol.for("react.forward_ref"), REACT_SUSPENSE_TYPE = Symbol.for("react.suspense"), REACT_SUSPENSE_LIST_TYPE = Symbol.for("react.suspense_list"), REACT_MEMO_TYPE = Symbol.for("react.memo"), REACT_LAZY_TYPE = Symbol.for("react.lazy");
    ...
    var ANIMATION_END = getVendorPrefixedEventName("animationend"), ANIMATION_ITERATION = getVendorPrefixedEventName("animationiteration"), ANIMATION_START = getVendorPrefixedEventName("animationstart"), TRANSITION_RUN = getVendorPrefixedEventName("transitionrun"), TRANSITION_START = getVendorPrefixedEventName("transitionstart"), TRANSITION_CANCEL = getVendorPrefixedEventName("transitioncancel"), TRANSITION_END = getVendorPrefixedEventName("transitionend"), topLevelEventsToReactNames = new Map(), simpleEventPluginEvents = "abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" "), CapturedStacks = new WeakMap(), OffscreenVisible = 1, OffscreenPassiveEffectsConnected = 2, concurrentQueues = [], concurrentQueuesIndex = 0, concurrentlyUpdatedLanes = 0, emptyContextObject = {};
    ...
    var supportsUserTiming = "undefined" !== typeof performance && "function" === typeof performance.measure, COMPONENTS_TRACK = "Components \u269b", reusableComponentDevToolDetails = {
        color: "primary",
        track: COMPONENTS_TRACK
    ...
    }, now = Scheduler.unstable_now, renderStartTime = -0, commitStartTime = -0, commitEndTime = -0, commitErrors = null, profilerStartTime = -1.1, profilerEffectDuration = -0, componentEffectDuration = -0, componentEffectStartTime = -1.1, componentEffectEndTime = -1.1, componentEffectErrors = null, blockingClampTime = -0, blockingUpdateTime = -1.1, blockingEventTime = -1.1, blockingEventType = null, blockingEventIsRepeat = !1, blockingSpawnedUpdate = !1, blockingSuspendedTime = -1.1, transitionClampTime = -0, transitionStartTime = -1.1, transitionUpdateTime = -1.1, transitionEventTime = -1.1, transitionEventType = null, transitionEventIsRepeat = !1, transitionSuspendedTime = -1.1, yieldReason = 0, yieldStartTime = -1.1, currentUpdateIsNested = !1, nestedUpdateScheduled = !1, currentEntangledListeners = null, currentEntangledPendingCount = 0, currentEntangledLane = 0, currentEntangledActionThenable = null, prevOnStartTransitionFinish = ReactSharedInternals.S;
    ...
    var shouldStartViewTransition = !1, appearingViewTransitions = null, viewTransitionCancelableChildren = null, viewTransitionHostInstanceIdx = 0, mountedNamedViewTransitions = new Map(), didWarnAboutName = {}, offscreenSubtreeIsHidden = !1, offscreenSubtreeWasHidden = !1, needsFormReset = !1, PossiblyWeakSet = "function" === typeof WeakSet ? WeakSet : Set, nextEffect = null, inProgressLanes = null, inProgressRoot = null, viewTransitionContextChanged$1 = !1, hostParent = null, hostParentIsContainer = !1, currentHoistableRoot = null, inHydratedSubtree = !1, suspenseyCommitFlag = 8192, didWarnForRootClone = !1, viewTransitionContextChanged = !1, CLONE_UPDATE = 0, CLONE_EXIT = 1, CLONE_UNHIDE = 2, CLONE_APPEARING_PAIR = 3, CLONE_UNCHANGED = 4, INSERT_EXIT = 5, INSERT_APPEND = 6, INSERT_APPEARING_PAIR = 7, DefaultAsyncDispatcher = {
    ...
    FragmentInstance.prototype.addEventListener = function(type, listener, optionsOrUseCapture) {
        ...
        }), traverseFragmentInstanceChildren(this._fragmentFiber.child, addEventListenerToChild, type, listener, optionsOrUseCapture));
    ...
    FragmentInstance.prototype.focus = function(focusOptions) {
        traverseFragmentInstanceChildren(this._fragmentFiber.child, setFocusIfFocusable, focusOptions, void 0, void 0);
    };
    FragmentInstance.prototype.focusLast = function(focusOptions) {
        var children = [];
        traverseFragmentInstanceChildren(this._fragmentFiber.child, collectChildren, children, void 0, void 0);
        for(var i = children.length - 1; 0 <= i && !setFocusIfFocusable(children[i], focusOptions); i--);
    };
    FragmentInstance.prototype.blur = function() {
        traverseFragmentInstanceChildren(this._fragmentFiber.child, blurActiveElementWithinFragment, void 0, void 0, void 0);
    };
    FragmentInstance.prototype.observeUsing = function(observer) {
        null === this._observers && (this._observers = new Set());
        this._observers.add(observer);
        traverseFragmentInstanceChildren(this._fragmentFiber.child, observeChild, observer, void 0, void 0);
    };
    ...
    FragmentInstance.prototype.getClientRects = function() {
        var rects = [];
        traverseFragmentInstanceChildren(this._fragmentFiber.child, collectClientRects, rects, void 0, void 0);
        return rects;
    };
    FragmentInstance.prototype.getRootNode = function(getRootNodeOptions) {
        var parentHostInstance;
        a: {
            for(parentHostInstance = this._fragmentFiber.return; null !== parentHostInstance;){
                if (3 === parentHostInstance.tag) {
                    parentHostInstance = parentHostInstance.stateNode.containerInfo;
                    break a;
                }
                if (5 === parentHostInstance.tag) {
                    parentHostInstance = parentHostInstance.stateNode;
                    break a;
                }
                parentHostInstance = parentHostInstance.return;
            }
            parentHostInstance = null;
        }
        return null === parentHostInstance ? this : parentHostInstance.getRootNode(getRootNodeOptions);
    };
    ...
    (function() {
        ...
        if ("19.2.0-experimental-63779030-20250328" !== isomorphicReactPackageVersion) throw Error('Incompatible React versions: The "react" and "react-dom" packages must have the exact same version. Instead got:\n  - react:      ' + (isomorphicReactPackageVersion + "\n  - react-dom:  19.2.0-experimental-63779030-20250328\nLearn more: https://react.dev/warnings/version-mismatch"));
    })();
...
//# sourceMappingURL=91e76_dist_compiled_react-dom-experimental_cjs_react-dom-client_development_2306064f.js.map