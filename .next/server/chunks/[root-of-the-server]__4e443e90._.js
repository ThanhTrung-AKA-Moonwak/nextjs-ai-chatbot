...
"[project]/.next-internal/server/app/(chat)/api/document/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/(chat)/api/document/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (!id) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("bad_request:api", "Parameter id is missing").toResponse();
    }
    ...
    if (!session?.user) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("unauthorized:document").toResponse();
    }
    const documents = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$queries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDocumentsById"])({
        id
    });
    const [document] = documents;
    if (!document) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("not_found:document").toResponse();
    }
    if (document.userId !== session.user.id) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("forbidden:document").toResponse();
    }
...
async function POST(request) {
    ...
    const id = searchParams.get("id");
    if (!id) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("bad_request:api", "Parameter id is required.").toResponse();
    }
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$auth$292f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"])();
    if (!session?.user) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("not_found:document").toResponse();
    ...
    const document = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$queries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveDocument"])({
        id,
        content,
        title,
        kind,
...
async function DELETE(request) {
    ...
    if (!timestamp) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("bad_request:api", "Parameter timestamp is required.").toResponse();
    }
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$auth$292f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"])();
    if (!session?.user) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatSDKError"]("unauthorized:document").toResponse();
    ...
    const documentsDeleted = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$queries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteDocumentsByIdAfterTimestamp"])({
        id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4e443e90._.js.map